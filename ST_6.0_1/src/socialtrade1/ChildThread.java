...
public class ChildThread  extends Thread{
    ...
    void Get()
    {
        ...
        try{
          ...
          response=response1.toString();
            new Save("get11",response,Utilities.Data[PositionNumber][0]).start();
            if(printResponse)System.out.println(response);
            Utilities.ThreadResponse[PositionNumber][state]=response;
    ...
    void tree()
    {
        ...
        try
        {
            String f1="\"d\":\"\\u003ctable style=\\u0027text-align:Left;\\u0027\\u003e\\u003ctr\\u003e\\u003ctd  style=\\u0027text-align:Left;\\u0027 \\u003eName\\u003c/td\\u003e\\u003ctd style=\\u0027text-align:Left;\\u0027\\u003e:\\u003c/td\\u003e\\u003ctd style=\\u0027padding-left:5px;text-align:Left;\\u0027 \\u003e";
        String f2="\\u003c/td\\u003e\\u003c/tr\\u003e\\u003ctr\\u003e\\u003ctd  style=\\u0027text-align:Left;\\u0027\\u003eUser ID\\u003c/td\\u003e\\u003ctd  style=\\u0027text-align:Left;";
        int n1=response.indexOf(f1)+f1.length();
        int n2=response.indexOf(f2,n1);
        String name=response.substring(n1, n2).trim();
            
            
         f1="padding-left:5px;text-align:Left;\\u0027\\u003e";
         f2="\\u003c/td\\u003e\\u003c/tr\\u003e\\u003ctr\\u003e\\u003ctd  style=\\u0027text-align:Left";
         n1=response.indexOf(f1)+f1.length();
         n2=response.indexOf(f2,n1);
        String  id=response.substring(n1, n2).trim();
  
     f1="\\u003c/td\\u003e\\u003c/tr\\u003e\\u003ctr\\u003e\\u003ctd  style=\\u0027text-align:Left;\\u0027\\u003eLeft Active BV \\u003c/td\\u003e\\u003ctd style=\\u0027text-align:Left;\\u0027\\u003e:\\u003c/td\\u003e\\u003ctd style=\\u0027padding-left:5px;text-align:Left;\\u0027\\u003e ";
     f2="\\u003c/td\\u003e\\u003c/tr\\u003e\\u003ctr\\u003e\\u003ctd";
        n1=response.indexOf(f1)+f1.length();
        n2=response.indexOf(f2,n1);
        String left=response.substring(n1, n2).trim();
    
        
        
        f1="\\u003c/td\\u003e\\u003c/tr\\u003e\\u003ctr\\u003e\\u003ctd  style=\\u0027text-align:Left;\\u0027\\u003eRight Active BV \\u003c/td\\u003e\\u003ctd style=\\u0027text-align:Left;\\u0027\\u003e:\\u003c/td\\u003e\\u003ctd style=\\u0027padding-left:5px;text-align:Left;\\u0027\\u003e";
        f2="\\u003c/td\\u003e\\u003c/tr\\u003e\\u003c/table\\u003e\"}";
        n1=response.indexOf(f1)+f1.length();
        n2=response.indexOf(f2,n1);
        String right=response.substring(n1, n2).trim();
      
        if(Float.parseFloat(right)>Utilities.rh)Utilities.rh=Float.parseFloat(right);
         if(Float.parseFloat(left)>Utilities.lh)Utilities.lh=Float.parseFloat(left);
         if(name.indexOf("N/A")==-1)
         {
           System.out.println(Utilities.tc+","+Utilities.lh+","+Utilities.rh+","+name+","+id+","+left+","+right);
           Utilities.res=Utilities.res+"\n"+id+","+name+","+left+","+right;
                Utilities.tc++;
         }
         else
         {
